...
<body>
	<nav class="escolaNav">
		<ul>
			...
			<li><a href="cadastrarAluno.jsp">Disciplina</a></li>
			<li><a href="cadastrarAluno.jsp">Matrícula</a></li>
			<li><a href="cadastrarAluno.jsp">Professor</a></li>
			<li><a href="cadastrarAluno.jsp">Consultar</a></li>
